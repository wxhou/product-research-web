...
export const DEFAULT_QUALITY_THRESHOLDS: ProgressQualityThresholds = {
  minSearchResults: RESEARCH_QUALITY_THRESHOLDS.minSearchResults,
  minExtractions: RESEARCH_QUALITY_THRESHOLDS.minExtractions,
  minFeatures: RESEARCH_QUALITY_THRESHOLDS.minFeatures,
  minCompetitors: RESEARCH_QUALITY_THRESHOLDS.minCompetitors,
  minConfidenceScore: RESEARCH_QUALITY_THRESHOLDS.minConfidenceScore,
};
